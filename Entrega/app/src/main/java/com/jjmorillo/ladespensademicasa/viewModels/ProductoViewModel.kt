...
class ProductoViewModel : ViewModel() {
    ...
    private fun cargarProductos() {
        ...
        viewModelScope.launch {
           ...
           val novedad= withContext(Dispatchers.IO) {
               db.productoDao().findAllByCategoria("novedad")

           }
            _productos.postValue(novedad)
        }
...
*/
        viewModelScope.launch {
            val lista = withContext(Dispatchers.IO){
                db.productoDao().findAllByCategoria("alimentacion")
            }
            liveData.postValue(lista)//MAIN THREAD
        }
...
*/
        viewModelScope.launch {
            val lista = withContext(Dispatchers.IO){
                db.productoDao().findAllByCategoria("bebida")
            }
            liveData.postValue(lista)//MAIN THREAD
        }
    ...
    fun obtenerDrogueriaLimpieza():LiveData<List<Producto>>{
       ...
       /* productos.add(Producto(1, "Detergente ropa", "ARIEL", "Detergente líquido Alpine Ariel 50 lavados.", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/ariel.jpg?alt=media&token=a0b4ad6b-266c-403e-a2af-0d5eb1fd5f16", 0.28, 13.95))
        productos.add(Producto(2, "Limpiador desinfectante", "SANYTOL", "Limpiador desinfectante multiusos sin lejía Sanytol 750 ml", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/desinfectante.jpg?alt=media&token=f524421b-65b0-414e-8f2e-9f537d04d232", 3.13, 2.35))
        productos.add(Producto(3, "Limpiador de baño", "DON LIMPIO", "Limpiador de baño Don Limpio 1,5 l.", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/donlimpio.jpg?alt=media&token=94c6dce2-6491-4367-b55c-4e045465b206", 1.50, 2.25))
        productos.add(Producto(4, "Lavavajillas a mano", "FAIRY", "Lavavajillas a mano Fairy Ultra Poder 650 ml.", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/fairy.jpg?alt=media&token=431d8ffc-9c08-453c-b5a7-040169e3b644", 4.62, 3.00))
        productos.add(Producto(5, "Lejía", "CONEJO", "Lejía acción total Conejo 2 l.", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/lejia.jpg?alt=media&token=600dd6f4-2047-4e77-9dc3-291f48d3964a", 0.89, 1.79))
        productos.add(Producto(6, "Caja de pañuelos", "KLEENEX", "Caja de pañuelos Family Kleenex 140 ud.", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/pa%C3%B1uelos.jpg?alt=media&token=cfcf2216-eafc-4af8-ba29-2f65528c5974", 0.01, 1.80))
        productos.add(Producto(7, "Papel higiénico", "SCOTTEX", "Papel higiénico acolchado toque de seda Scottex 24 rollos.", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/papelhigienico.jpg?alt=media&token=f47d62b4-9065-4a1c-b88f-bec5036ba4c7", 0.44, 10.50))
        productos.add(Producto(8,"Quitagrasas", "KH-7 ", "Quitagrasas original KH-7 recambio 750 ml.", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/quitagrasas.jpg?alt=media&token=535a02bd-ae21-4a9a-b1fb-4b15afa772c8", 3.59, 2.69))
        productos.add(Producto(9, "Servilletas", "RENOVA", "Set de Servilletas 1 capa de Celulosa RENOVA 200 200pz - Blancas", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/servilletas.jpg?alt=media&token=646767a5-1403-4492-8554-f119066a659a", 0.01, 0.92))
        productos.add(Producto(10, "Suavizante concentrado", "FLOR", "Suavizante concentrado azul Flor 72 lavados.", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/suavizante.jpg?alt=media&token=f4fc4fb7-06a3-43a6-a6cf-6b0f6b717fe9", 0.05, 3.94))
*/
        viewModelScope.launch {
            val lista = withContext(Dispatchers.IO){
                db.productoDao().findAllByCategoria("drogueria")
            }
            liveData.postValue(lista)//MAIN THREAD
        }
...
*/
        viewModelScope.launch {
            val lista = withContext(Dispatchers.IO){
                db.productoDao().findAllByCategoria("fruta")
            }
            liveData.postValue(lista)//MAIN THREAD
        }
...
*/
        viewModelScope.launch {
            val lista = withContext(Dispatchers.IO){
                db.productoDao().findAllByCategoria("carne")
            }
            liveData.postValue(lista)//MAIN THREAD
        }
...
*/
        viewModelScope.launch {
            val lista = withContext(Dispatchers.IO){
                db.productoDao().findAllByCategoria("lacteos")
            }
            liveData.postValue(lista)//MAIN THREAD
        }
...
*/
        viewModelScope.launch {
            val lista = withContext(Dispatchers.IO){
                db.productoDao().findAllByCategoria("pan")
            }
            liveData.postValue(lista)//MAIN THREAD
        }
    ...
    fun obtenerPescados():LiveData<List<Producto>>{
       ...
       /* productos.add(Producto(1, "Lubina", "PESCADO", "Lubina de ración 500 g aprox", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/lubina.jpg?alt=media&token=16ec7cf7-79ed-43b4-800f-35d8c879af54", 6.45, 3.22))
        ...
        productos.add(Producto(10, "Pescadilla", "PESCADO", "Pescadill*//*a fina 1 kg aprox", "https://firebasestorage.googleapis.com/v0/b/la-despensa-de-mi-casa.appspot.com/o/pescadilla.jpg?alt=media&token=52ffbc06-5484-4d6c-a405-85e0f39647e9", 5.90, 5.90))*/

        viewModelScope.launch {
            val lista = withContext(Dispatchers.IO){
                db.productoDao().findAllByCategoria("pescado")
            }
            liveData.postValue(lista)//MAIN THREAD
        }
